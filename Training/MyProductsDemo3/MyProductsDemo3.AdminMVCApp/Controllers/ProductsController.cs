...
using MyProductsDemo3.AdminMVCApp.Models;
...
namespace MyProductsDemo3.AdminMVCApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,ProdDescription,Model,Price,Keywords,CategoryId,Active")] Product product)
        {
            if (ModelState.IsValid)
            {
